...
-Some bosses are broken after randomizing:
  ...
  - UME_M_SkullJuggernaut_01 kill cutscene teleports the player out of bounds
  ...
  - SE_M_WeaponMasterB_01 escape cutscene teleports the player out of bounds
...
- Balancing issues:
  - NST_M_ElderPhase1_01 is not really a boss fight so he's boring to encounter. Making custom changes to his AI could be fun. Or add an option to remove him from the boss pool
  ...
  - The first Belial encounter is likely unbalanced since the game doesn't expect you to reduce the boss' HP to zero
